...
import Exceptions.CurrencyNotModifiedException;
...
public class CurrencyServlet extends HttpServlet {
    ...
    private static final String ERROR_NOT_MODIFIED = "No changes to apply";
    ...
    protected void doPatch(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            Response.writeJsonResponse(resp, updatedCurrency);
        }
        catch (InvalidCurrencyCodeException e){
            resp.sendError(HttpServletResponse.SC_BAD_REQUEST, ERROR_INVALID_CURRENCY_CODE);
        }
        ...
        catch (CurrencyNotModifiedException e){
            resp.sendError(HttpServletResponse.SC_BAD_REQUEST, ERROR_NOT_MODIFIED);
        }
        catch (Exception e) {
            resp.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, ERROR_MESSAGE);
        }
