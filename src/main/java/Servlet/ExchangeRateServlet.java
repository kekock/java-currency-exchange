...
public class ExchangeRateServlet extends HttpServlet {
    ...
    private static final String ERROR_MISSING_FIELDS_MESSAGE = "Missing required form fields.";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            resp.sendError(HttpServletResponse.SC_NOT_FOUND, ERROR_PAIR_NOT_FOUND_MESSAGE);
        } catch (Exception e) {
    ...
    protected void doPatch(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            resp.sendError(HttpServletResponse.SC_BAD_REQUEST, ERROR_MISSING_FIELDS_MESSAGE);
        }
        catch (NotFoundException e) {
            resp.sendError(HttpServletResponse.SC_NOT_FOUND, ERROR_PAIR_NOT_FOUND_MESSAGE);
        }
